                    ...
                    <div className="max-w-[1000px] mx-auto">
                        <div className="flex flex-col items-center md:flex-row justify-around gap-6 md:gap-10">
                            ...
                            <div className="bg-white flex flex-col gap-4 w-fit">
                                ...
                                <Link href="/product/5" className="inline-flex flex-row flex-nowrap items-center justify-center gap-1 bg-[#FFF8F8] border border-[#ED0000] rounded-full px-4 py-2 cursor-pointer whitespace-nowrap hover:opacity-90">
                            ...
                            <div className="bg-white flex flex-col gap-4 w-fit">
                                ...
                                <Link href="/product/10" className="inline-flex flex-row flex-nowrap items-center justify-center gap-1 bg-[#FFF8F8] border border-[#ED0000] rounded-full px-4 py-2 cursor-pointer whitespace-nowrap hover:opacity-90">
                                    <span className="text-[#ED0000] text-base">購入する</span>
                                    <span className="shrink-0"><ArrowRight color="#ED0000" /></span>
                                </Link>
                            </div>
                            ...
                            <div className="bg-white flex flex-col gap-4 w-fit">
                                ...
                                <Link href="/product/20" className="inline-flex flex-row flex-nowrap items-center justify-center gap-1 bg-[#FFF8F8] border border-[#ED0000] rounded-full px-4 py-2 cursor-pointer whitespace-nowrap hover:opacity-90">
                                    <span className="text-[#ED0000] text-base">購入する</span>
                                    <span className="shrink-0"><ArrowRight color="#ED0000" /></span>
                                </Link>
                            </div>
                    ...
                    <div className="relative z-10 md:mt-20 mt-8">
                        <div className="flex flex-col items-center md:flex-row justify-around gap-6 md:gap-10 bg-white max-w-[1000px] mx-auto py-8 md:py-10 px-4 md:px-5  shadow-[4px_4px_4px_3px_rgba(0,0,0,0.06)]">
                            ...
                            <div className="bg-white flex flex-col gap-3 md:gap-4 w-fit">
                                ...
                                <Link href="/product/5" className="inline-flex flex-row flex-nowrap items-center justify-center gap-1 bg-[#FFF8F8] border border-[#ED0000] rounded-full px-3 py-1.5 md:px-4 md:py-2 cursor-pointer whitespace-nowrap hover:opacity-90">
                            ...
                            <div className="bg-white flex flex-col gap-3 md:gap-4">
                                ...
                                <Link href="/product/10" className="inline-flex flex-row flex-nowrap items-center justify-center gap-1 bg-[#FFF8F8] border border-[#ED0000] rounded-full px-3 py-1.5 md:px-4 md:py-2 cursor-pointer whitespace-nowrap hover:opacity-90">
                                    <span className="text-[#ED0000] text-sm md:text-base">購入する</span>
                                    <span className="shrink-0"><ArrowRight color="#ED0000" /></span>
                                </Link>
                            </div>
                            ...
                            <div className="bg-white flex flex-col gap-3 md:gap-4">
                                ...
                                <Link href="/product/20" className="inline-flex flex-row flex-nowrap items-center justify-center gap-1 bg-[#FFF8F8] border border-[#ED0000] rounded-full px-3 py-1.5 md:px-4 md:py-2 cursor-pointer whitespace-nowrap hover:opacity-90">
                                    <span className="text-[#ED0000] text-sm md:text-base">購入する</span>
                                    <span className="shrink-0"><ArrowRight color="#ED0000" /></span>
                                </Link>
                            </div>
